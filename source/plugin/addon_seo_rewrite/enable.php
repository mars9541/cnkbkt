...
$addonid = $plugin['identifier'].'.plugin';//1_3.1.4.学.习.网
...
cpmsg('plugins_'.$operation.'_succeed', 'action=plugins'.(!empty($_GET['system']) ? '&system=1' : ''), 'succeed');#本插件为 1314 学 习 网（www . 1314Study . com） 独立开发的原创插件, 依法拥有版权
}
