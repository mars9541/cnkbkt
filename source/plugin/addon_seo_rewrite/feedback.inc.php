 ...
 * This is NOT a freeware, use is subject to license terms
 * $Id: feedback.inc.php 961 2023-01-12 19:00:21
...
require_once ('pluginvar.func.php');//http://t.cn/hbdjxV
require_once DISCUZ_ROOT.'./source/discuz_version.php';
if(!$plugin && defined('CURMODULE')) {
$plugin = C::t('common_plugin')->fetch_by_identifier(CURMODULE);
}
$data = 'pid='.$plugin['identifier'].'&siteurl='.rawurlencode($_G['siteurl']).'&sitever='.DISCUZ_VERSION.'/'.DISCUZ_RELEASE.'&sitecharset='.CHARSET.'&pversion='.rawurlencode($plugin['version']);splugin_thinks($plugin['identifier'], defined('CURMODULE') ? 1:0);//  1.3.14.学.习.网
...
//This is NOT a freeware, use is subject to license terms
//$Id: feedback.inc.php 1424 2023-01-12 11:00:21
