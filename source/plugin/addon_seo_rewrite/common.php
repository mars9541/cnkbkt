...
function splugin_think($identifier, $show = '0') {
	...
	if (!empty($identifier) && ispluginkey($identifier)) {
		...
		if (@!file_exists(DISCUZ_ROOT . './data/ad' . 'don' . 'md' . '5/' . $identifier . '.pl' . 'ug' . 'in.x' . 'm' . 'l')) {
			$return = '1';
		} elseif ($plugin['co' . 'pyri' . 'ght'] && stripos($plugin['c' . 'opy' . 'rig' . 'ht'], '1314') === false) {
			$return = '1';
		} elseif ($plugin['co' . 'pyri' . 'ght'] && stripos($plugin['c' . 'opy' . 'rig' . 'ht'], '8') !== false) {
			$return = '1';
		} elseif (!getcookie('splugin_think_' . $identifier) || (abs($_G['timestamp'] - getcookie('splugin_think_' . $identifier)) > 86400)) {
		...
		if ($return) {
			...
			echo "&#x611F;&#x8C22;&#x4F7F;&#x7528;1314&#x5B66;&#x4E60;&#x7F51;&#x7684;&#x63D2;&#x4EF6;&#xFF0C;&#x767E;&#x5EA6;&#x641C;&#x7D22; 1314&#x5E94;&#x7528;&#x4E2D;&#x5FC3; &#x83B7;&#x53D6;&#x66F4;&#x591A;&#x5E94;&#x7528;&#x3002;<div style='display:none'>\n2022042908SzLykL3p4f\n62812\n1673521625\nhttp://cnkbtk.com/\nhttps://www.cnkbtk.com/\n6353148D-8D77-FCB9-CDE2-AB6CC40BE601\nEF653FEB-52A1-06FB-F699-0D70AB36FC9A</div>";
		}
	}
}
...
function splugin_updatecache($identifier) {
	...
	if (!empty($identifier) && ispluginkey($identifier)) {
		...
		$cachevalue['sn'] = '2022042908SzLykL3p4f';
...
function s_shownav($header = '', $menu = '', $nav = '') {
	...
	$title = '<' . 'b' . ' style="color:red;">&#x672C;&#x63D2;&#x4EF6;&#x7531;1314&#x5B66;&#x4E60;&#x7F51;&#x5F00;&#x53D1;&#xFF0C;&#x4F7F;&#x7528;&#x95EE;&#x9898;&#x8BF7;&#x5230;1314&#x5B66;&#x4E60;&#x7F51;&#xFF08;<' . 'a hr' . 'ef' . '="htt' . 'p:/' . '/ww' . 'w.1' . '314s' . 'tud' . 'y.co' . 'm/" tar' . 'get="_blank" class="a1314">ww' . 'w.13' . '14' . 'st' . 'udy.co' . 'm</' . 'a>&#xFF09;&#x53CD;&#x9988;</b' . '><style>.currentloca .a1314{display: unset;position: unset;background-color: unset; color: #2b7acd;}.currentloca .a1314::before, .currentloca .a1314::after {background: #2b7acd;width: 0px;height: 0px;}}</style>';
