 ...
 * $Id: mobilehook.class.php 534 2020-06-26 21:04:04Z zhuge $
...
class mobileplugin_zzbuluo_baidu360push
{
    ...
    public function global_footer_mobile()
    {
        ...
        if (!$splugin_setting['zzbuluo_mbdradio']) {
            return '';
        }
...
//Copyright 2001-2099 1314学习网.
//This is NOT a freeware, use is subject to license terms
//$Id: mobilehook.class.php 985 2020-06-26 13:04:04Z zhuge $
//应用售后问题：http://www.1314study.com/services.php?mod=issue
//应用售前咨询：QQ 15326940
//应用定制开发：QQ 643306797
//本插件为 1314学习网（www.1314study.com） 独立开发的原创插件, 依法拥有版权。
