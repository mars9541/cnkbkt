...
<div class="footer-wrapper cl" id="footerWrapper" style="margin: 20px 0 0 0; overflow: hidden; text-align: center; border-top: 1px solid #eee; background: #FFFFFF;">
<div class="section cl">
  <div class="footer-main" style="width: 1200px; padding: 30px 0 45px 0;">
    <div class="cl">
      <p><?php if($_G['setting']['icp']) { ?><a href="https://beian.miit.gov.cn/" target="_blank">  <?php echo $_G['setting']['icp'];?></a><?php } ?>&nbsp;&copy; 2022 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc. </a>Powered by <a href="http://www.discuz.net" target="_blank">Discuz!</a> <?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?>
