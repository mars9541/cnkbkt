...
0
|| checktplrefresh('data/diy/./template/elec_20220314_miaoly//forum/forumdisplay_36.htm', './template/elec_20220314_miaoly/forum/forumdisplay_leftside.htm', 1677494345, 'diy', './data/template/2_diy_forum_forumdisplay_36.tpl.php', 'data/diy/./template/elec_20220314_miaoly/', 'forum/forumdisplay_36')
|| checktplrefresh('data/diy/./template/elec_20220314_miaoly//forum/forumdisplay_36.htm', './template/default/forum/recommend.htm', 1677494345, 'diy', './data/template/2_diy_forum_forumdisplay_36.tpl.php', 'data/diy/./template/elec_20220314_miaoly/', 'forum/forumdisplay_36')
|| checktplrefresh('data/diy/./template/elec_20220314_miaoly//forum/forumdisplay_36.htm', './template/default/common/seccheck.htm', 1677494345, 'diy', './data/template/2_diy_forum_forumdisplay_36.tpl.php', 'data/diy/./template/elec_20220314_miaoly/', 'forum/forumdisplay_36')
|| checktplrefresh('data/diy/./template/elec_20220314_miaoly//forum/forumdisplay_36.htm', './template/elec_20220314_miaoly/forum/forumdisplay_list.htm', 1677494345, 'diy', './data/template/2_diy_forum_forumdisplay_36.tpl.php', 'data/diy/./template/elec_20220314_miaoly/', 'forum/forumdisplay_36')
|| checktplrefresh('data/diy/./template/elec_20220314_miaoly//forum/forumdisplay_36.htm', './template/default/forum/forumdisplay_sort.htm', 1677494345, 'diy', './data/template/2_diy_forum_forumdisplay_36.tpl.php', 'data/diy/./template/elec_20220314_miaoly/', 'forum/forumdisplay_36')
|| checktplrefresh('data/diy/./template/elec_20220314_miaoly//forum/forumdisplay_36.htm', './template/default/forum/search_sortoption.htm', 1677494345, 'diy', './data/template/2_diy_forum_forumdisplay_36.tpl.php', 'data/diy/./template/elec_20220314_miaoly/', 'forum/forumdisplay_36')
|| checktplrefresh('data/diy/./template/elec_20220314_miaoly//forum/forumdisplay_36.htm', './template/default/forum/search_sortoption.htm', 1677494345, 'diy', './data/template/2_diy_forum_forumdisplay_36.tpl.php', 'data/diy/./template/elec_20220314_miaoly/', 'forum/forumdisplay_36')
...
.ttp .a a { padding: 0; font-size: 16px; height: 30px;
    font-size: 16px;
    color: #FF6651;
    border-bottom: 3px solid #FF6651;
    font-weight: bold;
...
.bdl dt { background: url(template/elec_20220314_miaoly/style/ba_r.png) no-repeat 158px center}
.bdl dl.a dt { background: url(template/elec_20220314_miaoly/style/ba_d.png) no-repeat 156px center}
...
#f_pst .bm_h h2 { font-weight: 400; color: #FF6651}
...
#fastpostsubmit.pn { border-radius: 2px; background: #FF6651 !important; box-shadow: none; font-weight: 400}
...
<div class="focusbox" style="display: none;"><div class="wp"><h1 class="focusbox-title"><?php echo $_G['forum']['name'];?></h1></div></div>
<div class="section">
<div class="wp cl">
...
<?php if($leftside) { ?>
<div id="sd_bdl" class="bdl" onmouseover="showMenu({'ctrlid':this.id, 'pos':'dz'});" style="border-radius: 4px; overflow: hidden; width:<?php echo $_G['setting']['leftsidewidth'];?>px;margin-left:-<?php echo $_G['leftsidewidth_mwidth'];?>px">
...
<div class="tbn cl" id="forumleftside"><?php if($leftside['favorites']) { ?>
...
<?php } else { ?>
<div class="cl" style="padding: 18px 0 14px 0; border-bottom: 1px solid #EEEEEE;"><h2 class="bdl_h">版块导航</h2></div>
...
<div class="mn">
<div class="forum_list_top bm bml pbn cl" style="padding: 18px 10px 22px 20px !important; margin-bottom: 20px !important; border-radius: 4px;">
               <div class="avatar_left z cl" style="width: 80px; margin-right: 20px;">
                  <?php if($_G['forum']['icon']) { ?><img src="data/attachment/common/<?php echo $_G['forum']['icon'];?>" alt="<?php echo $_G['forum']['name'];?>" style="width: 100%; border-radius: 50%;"><?php } else { ?><img src="template/elec_20220314_miaoly/style/icon_bg.png" alt="<?php echo $_G['forum']['name'];?>" style="width: 100%; border-radius: 50%;"><?php } ?>
               </div>
               <div class="avatar_right cl">
<div class="bm_h cl" style="margin-bottom: 10px; padding-left: 0;">
<?php if($_G['page'] == 1 && $_G['forum']['rules']) { ?><span class="o" style="display: none;"><img id="forum_rules_<?php echo $_G['fid'];?>_img" src="<?php echo IMGDIR;?>/collapsed_<?php echo $collapse['forum_rulesimg'];?>.gif" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('forum_rules_<?php echo $_G['fid'];?>')" /></span><?php } ?>
                    <h1 class="xs2 z">
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" style="font-size: 20px; font-weight: bold; float: left;"><?php echo $_G['forum']['name'];?></a>
<div class="z cl"><?php if(!$subforumonly) { ?><span class="xs1 xw0 i">今日: <em class="xi1"><?php echo $_G['forum']['todayposts'];?></em><span class="pipe">|</span>主题: <em class="xi1"><?php echo $_G['forum']['threads'];?></em></span><?php } ?></div>
</h1>
<span class="z" style="margin: 0 0 0 20px;">
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" style="color: #FF6651;">收藏本版 <em class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</em></a>
...
<?php } ?>
                    ...
                    <?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖" style="float: right;"><img src="template/elec_20220314_miaoly/style/post.png" alt="发新帖" /></a><?php } ?>
                    <?php if($moderatedby) { ?><div class="banzhu y cl" style="margin: 0 146px 0 0;">版主: <span class="xi2"><?php echo $moderatedby;?></span></div><?php } ?>
</div>
...
<?php } if($moderatedby) { ?><div style="display: none;">版主: <span class="xi2"><?php echo $moderatedby;?></span></div><?php } if($_G['page'] == 1 && $_G['forum']['rules']) { ?>
<div id="forum_rules_<?php echo $_G['fid'];?>" style="<?php echo $collapse['forum_rules'];?>;">
<div class="ptn xg2"><em style="color: #FF6651;">版块规则： </em>em<?php echo $_G['forum']['rules'];?></div>
</div>
<?php } ?>
</div>
<?php } if(!empty($forumarchive)) { ?>
...
<div class="drag">
<!--[diy=diy4]--><div id="diy4" class="area"><div id="framekWhd1G" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext" style="margin-left:300px;color:rgb(0, 0, 0);">此处收录入驻本站的制作组的作品</span></div><div id="framekWhd1G_left" class="column frame-1-c"><div id="framekWhd1G_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
...
<div class="bm bmw fl<?php if($_G['forum']['forumcolumns']) { ?> flg<?php } ?>" style="display: none;">
<div class="bm_h cl">
...
<?php if(empty($_G['forum']['sortmode'])) { ?><div id="threadlist" class="tl bm bmw cl" style="border-radius: 4px; <?php if($_G['uid']) { ?>position: relative;<?php } ?>">
...
<div class="tf">
<span id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="y atarget_1"<?php } else { ?>onclick="setatarget(1)" class="y"<?php } ?> title="在新窗口中打开帖子" style="margin: 3px 20px 0 0;">新窗</span>
...
<?php } } else { ?>
                        ...
                        <style type="text/css">
.focusbox { display: block !important}
#pt { display: none}
.forum_list_top { display: none}
#threadlist { border: 0 !important}
#threadlist .bm_c { padding: 0 !important}
.miao_list { width: 1200px !important; height: auto !important}
.tl .th { padding: 0 !important; border: 0 !important; background: none !important}
.tl .th th { display: none}
.pgbtn { display: none}
@media (max-width: 1200px){
.miao_list { width: 100% !important}
.tl .by {
    display: block !important;
}
}
</style>
<ul id="waterfall" class="miao_list cl"><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if($_G['hiddenexists'] && $thread['hidden']) { continue;?><?php } if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { if($thread['related_group'] == 0 && $thread['closed'] > 1) { $thread[tid]=$thread[closed];?><?php } } $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth] + 24;?>                                            <li>
            <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?> <?php if($thread['isgroup'] == 1 || $thread['forumstick'] || CURMODULE == 'guide') { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> title="<?php echo $thread['subject'];?>" class="img_box">
            <?php if($thread['cover']) { ?>
<img src="<?php echo $thread['coverpath'];?>" alt="<?php echo $thread['subject'];?>" width="<?php echo $_G['setting']['forumpicstyle']['thumbwidth'];?>" / style="width: auto; height: 330px;">
<?php } else { ?>
<img src="template/elec_20220314_miaoly/style/nopic.jpg" alt="<?php echo $thread['subject'];?>" style="width: auto; height: 330px;">
<?php } ?>
            </a>
            <div class="info_box cl">
            <h3>
            <?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_thread'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_thread'][$key];?>
                <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?> <?php if($thread['isgroup'] == 1 || $thread['forumstick'] || CURMODULE == 'guide') { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> title="<?php echo $thread['subject'];?>" target="_blank"><?php echo $thread['subject'];?></a>
            </h3>
            <div class="time cl"><?php echo $thread['dateline'];?><?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?></div>
            </div>
        </li>
<?php } ?>
</ul>
...
<span <?php if($_G['setting']['visitedforums']) { ?>id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?> class="pgb y" style="display: none;"><a href="forum.php">返&nbsp;回</a></span>
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖" style="display: none;"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="发新帖" /></a><?php } ?>
