...
<?php if(!empty($allowuploadnum)) { ?><a href="javascript:;" onclick="uploadWindow(function (aid, url, name){$('attachupdate<?php echo $attach['aid'];?>').value = aid;$('attachname<?php echo $attach['aid'];?>').title = '';$('attachname<?php echo $attach['aid'];?>').innerHTML = name;$('attachname<?php echo $attach['aid'];?>').onmouseover=null}, 'file');return false;">更新</a><?php } } ?>
</p>
