...
0
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/common/userabout.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/home/space_header.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/common/seditor.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/common/upload.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/common/seccheck.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/home/follow_feed_li.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/home/space_userabout.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/elec_20220314_miaoly/common/header_common.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/home/space_diy.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
|| checktplrefresh('./template/elec_20220314_miaoly/home/follow_feed.htm', './template/default/home/space_header_personalnv.htm', 1677895285, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/elec_20220314_miaoly', 'home/follow_feed')
;?>
<?php if($_GET['mod'] == 'follow' && $_GET['do']=='follower' && $_GET['uid']=='' && $_GET['page']!='') { dheader("Location: home.php?mod=follow&do=follower&uid=$_G[uid]&page=$_GET[page]");exit;?><?php } elseif($_GET['mod'] == 'follow' && $_GET['do']=='follower' && $_GET['uid']=='') { dheader("Location: home.php?mod=follow&do=follower&uid=$_G[uid]");exit;?><?php } if($_GET['mod'] == 'follow' && $_GET['do']=='following' && $_GET['uid']=='' && $_GET['page']!='') { dheader("Location: home.php?mod=follow&do=following&uid=$_G[uid]&page=$_GET[page]");exit;?><?php } elseif($_GET['mod'] == 'follow' && $_GET['do']=='following' && $_GET['uid']=='') { dheader("Location: home.php?mod=follow&do=following&uid=$_G[uid]");exit;?><?php } if($_GET['uid']) { include template('home/space_header_cont_2'); include template('home/space_menu'); if(in_array($do, array('feed', 'view'))) { include template('home/space_index_2'); } elseif(in_array($do, array('following', 'follower'))) { ?>
...
<!--<div class="active-filter-down">
<span class="medium-title left"></span>
</div>-->
<div class="designer-list-box clear mt-20"><?php if(is_array($list)) foreach($list as $fuid => $fuser) { if($do=='following') { $follow_member_count = get_member_count($fuser[followuid]);?><?php $follow_member_profile = get_member_profile($fuser[followuid]);?><div class="card-designer-list">
<a href="home.php?mod=space&amp;uid=<?php echo $fuser['followuid'];?>" title="<?php echo $fuser['fusername'];?>" class="avatar" target="_blank">
<img src="<?php echo avatar($fuser['followuid'],'big',1);; ?>" width="80" height="80" alt="">
</a>
<div class="author-info">
<p class="author-info-title">
<a href="home.php?mod=space&amp;uid=<?php echo $fuser['followuid'];?>" title="<?php echo $fuser['fusername'];?>" target="_blank" class="title-content"><?php echo $fuser['fusername'];?>&nbsp;<span id="followbkame_<?php echo $fuser['followuid'];?>" class="xg1 xs1 xw0"><?php if($fuser['bkname']) { ?><?php echo $fuser['bkname'];?><?php } ?></span></a>
</p>
<div class="position-info">
<span>
<?php if($follow_member_profile['residecity']) { ?><?php echo $follow_member_profile['residecity'];?><?php } else { ?>未来城市<?php } if($follow_member_profile['occupation']) { ?>&nbsp;|&nbsp;<?php echo $follow_member_profile['occupation'];?><?php } ?>
</span>
...
<div class="work">
<span>创作</span>
<a href="home.php?mod=follow&amp;uid=<?php echo $space['uid'];?>" target="_blank" title="共创作<?php echo $follow_member_count['threads'];?>组作品/帖子"><?php echo $follow_member_count['threads'];?></a>
<i></i>
</div>
<div class="work">
<span>听众</span>
<a href="home.php?mod=follow&amp;do=follower&amp;uid=<?php echo $fuser['followuid'];?>" target="_blank" title="共<?php echo $memberinfo[$fuid]['follower'];?>听众"><span id="followernum_<?php echo $fuser['followuid'];?>"><?php echo $memberinfo[$fuid]['follower'];?></span></a>
<?php if($viewself && $fuser['followuid'] != $_G['uid']) { ?><i></i><?php } ?>
</div>
...
<div class="signature">
<p><?php echo $fuser['recentnote'];?></p>
</div>
<div class="btn-area">
<?php if($viewself) { ?>
<a id="a_followmod_<?php echo $fuser['followuid'];?>" href="home.php?mod=spacecp&amp;ac=follow&amp;op=del&amp;fuid=<?php echo $fuser['followuid'];?>" onclick="ajaxget(this.href);doane(event);" class="btn-current attention btn-default-secondary following lh33">取消收听</a>
<?php } elseif($fuser['followuid'] != $_G['uid']) { if($fuser['mutual']) { ?>
<a id="a_followmod_<?php echo $fuser['followuid'];?>" href="home.php?mod=spacecp&amp;ac=follow&amp;op=del&amp;fuid=<?php echo $fuser['followuid'];?>"  onclick="ajaxget(this.href);doane(event);" class="btn-current attention btn-default-secondary following lh33">取消收听</a>
<?php } elseif(helper_access::check_module('follow')) { ?>
<a id="a_followmod_<?php echo $fuser['followuid'];?>" href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $fuser['followuid'];?>" onclick="ajaxget(this.href);doane(event);" class="btn-default-main btn-current attention notfollow lh33">收听</a>
<?php } } ?>
</div>
</div><?php $author_thread =get_uid_thread($fuser['followuid'],'dateline',3);?><div class="work-show">
<?php if($author_thread) { ?>
<ul class="work-con-box"><?php if(is_array($author_thread)) foreach($author_thread as $var) { ?><li class="work-show-item">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $var['tid'];?>" title="<?php echo $var['subject'];?>" class="card-img-hover" target="_blank">
<img src="<?php echo(getforumimg($var[aid],0,400,300))?>" width="200" height="150" alt="">
</a>
</li>
<?php } ?>
</ul>
<?php } else { ?>
<!--<ul class="work-con-box" style="background: #FBFBFB;border-radius: 4px;text-align: center;line-height: 150px;">
<p>暂无作品</p>
</ul>-->
<?php } ?>
<div class="seize-box">
<div class="work-show-more">
<a href="home.php?mod=space&amp;uid=<?php echo $fuser['followuid'];?>" title="<?php echo $fuser['fusername'];?>的个人主页" class="view-more" target="_blank">
<div class="more-icon">
...
<?php } else { $f_member_count = get_member_count($fuser[uid]);?><?php $f_member_profile = get_member_profile($fuser[uid]);?><div class="card-designer-list">
<a href="home.php?mod=space&amp;uid=<?php echo $fuser['uid'];?>" title="<?php echo $fuser['username'];?>" class="avatar" target="_blank">
<img src="<?php echo avatar($fuser['uid'],'big',1);; ?>" width="80" height="80" alt="">
</a>
<div class="author-info">
<p class="author-info-title">
<a href="home.php?mod=space&amp;uid=<?php echo $fuser['uid'];?>" title="<?php echo $fuser['username'];?>" target="_blank" class="title-content"><?php echo $fuser['username'];?></a>
</p>
<div class="position-info">
<span>
<?php if($f_member_profile['residecity']) { ?><?php echo $f_member_profile['residecity'];?><?php } else { ?>未来城市<?php } if($f_member_profile['occupation']) { ?>&nbsp;|&nbsp;<?php echo $f_member_profile['occupation'];?><?php } ?>
</span>
</div>
<div class="info-num">
<div class="work">
<span>创作</span>
<a href="home.php?mod=follow&amp;uid=<?php echo $space['uid'];?>" target="_blank" title="共创作<?php echo $f_member_count['threads'];?>组作品/帖子"><?php echo $f_member_count['threads'];?></a>
<i></i>
</div>
<div class="fans">
<span>听众</span>
<a href="home.php?mod=follow&amp;do=follower&amp;uid=<?php echo $fuser['uid'];?>" target="_blank" title="共<?php echo $memberinfo[$fuid]['follower'];?>听众"><span id="followernum_<?php echo $fuser['uid'];?>"><?php echo $memberinfo[$fuid]['follower'];?></span></a>
</div>
</div>
<div class="signature">
<p><?php echo $fuser['recentnote'];?></p>
...
<a id="a_followmod_<?php echo $fuser['uid'];?>" href="home.php?mod=spacecp&amp;ac=follow&amp;op=del&amp;fuid=<?php echo $fuser['uid'];?>"  onclick="ajaxget(this.href);doane(event);" class="btn-current attention btn-default-secondary following lh33">
取消收听
</a>
<?php } elseif(helper_access::check_module('follow')) { ?>
<a id="a_followmod_<?php echo $fuser['uid'];?>" href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $fuser['uid'];?>" onclick="ajaxget(this.href);doane(event);" class="btn-default-main btn-current attention notfollow lh33">
收听
</a>
<?php } } ?>
</div>
</div><?php $author_thread =get_uid_thread($fuser['uid'],'dateline',3);?><div class="work-show">
<?php if($author_thread) { ?>
<ul class="work-con-box"><?php if(is_array($author_thread)) foreach($author_thread as $var) { ?><li class="work-show-item">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $var['tid'];?>" title="<?php echo $var['subject'];?>" class="card-img-hover" target="_blank">
<img src="<?php echo(getforumimg($var[aid],0,400,300))?>" width="200" height="150" alt="">
...
<div class="seize-box">
<div class="work-show-more">
<a href="home.php?mod=space&amp;uid=<?php echo $fuser['uid'];?>" title="<?php echo $fuser['username'];?>的个人主页" class="view-more" target="_blank">
<div class="more-icon">
<span></span><span></span><span></span>
</div>
</a>
...
$('a_followmod_'+values['fuid']).className = 'btn-current attention btn-default-secondary following lh33';
}
...
if(values['from'] != 'block') {
$('a_followmod_'+values['fuid']).className = 'btn-default-main btn-current attention notfollow lh33';
}
...
</script><?php include template('home/space_footer_cont_2'); } else { if($do == 'feed') { if($_GET['mod'] == 'space') { dheader("Location: home.php?mod=space&uid=$_G[uid]");exit;?><?php } include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">
...
<?php } else { if($_GET['mod'] == 'space') { dheader("Location: home.php?mod=space&uid=$_G[uid]");exit;?><?php } if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
