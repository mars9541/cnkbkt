...
0
|| checktplrefresh('./template/elec_20220314_miaoly/home/space_profile.htm', './template/elec_20220314_miaoly/home/space_profile_body.htm', 1677493989, '2', './data/template/2_2_home_space_profile.tpl.php', './template/elec_20220314_miaoly', 'home/space_profile')
;?><?php include template('home/space_header_cont_2'); include template('home/space_menu'); ?><div class="image_contain">
<div class="space_boxs"><style type="text/css">
.home_bg { margin-bottom: 0 !important}
.md_ctrl img { max-width: 30px}
.pf_l li { width: 33.33%}

.u_profile { line-height: 28px}
.datum-title-box { padding-bottom: 8px; padding-top: 25px}
.all_post .pipe { padding: 0 16px; color: #E6E6E6}

</style>
<div class="u_profile" style="font-size: 13px; padding: 0; border-radius: 0; background: none;">

<div class="centerbox1 cl">
    
    		<ul class="all_post cl" style="padding: 20px; border-radius: 2px; background: #F6F6F6; display: none;">
<li>
...
<h2 class="datum-title-box" style="padding: 0 0 8px 0;">基本信息</h2>
<ul class="pf_l cl">
<li><em>用户名</em><?php echo $space['username'];?>
<?php if($_G['ols'][$space['uid']]) { ?>
<img src="<?php echo IMGDIR;?>/ol.gif" alt="online" title="在线" class="vm" />&nbsp;
<?php } ?>
</li>

<li><em>UID</em><?php echo $space['uid'];?><?php $isfriendinfo = 'home_friend_info_'.$space['uid'].'_'.$_G[uid];?><?php if($_G[$isfriendinfo]['note']) { ?>
...
<?php } if($space['medals']) { ?>
<div class="centerbox1 cl">
<h2 class="datum-title-box">勋章</h2>
<p class="md_ctrl">
...
<div class="centerbox1 cl">
<h2 class="datum-title-box">用户认证</h2><?php $showverify = false;?><?php } if($space['verify'.$vid] == 1) { ?>
...
<div class="centerbox1 cl">
<h2 class="datum-title-box">管理以下版块</h2><?php if(is_array($manage_forum)) foreach($manage_forum as $key => $value) { ?><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $key;?>" target="_blank"><?php echo $value;?></a> &nbsp;
<?php } ?>
</div>
<?php } if($groupcount) { ?>
<div class="centerbox1 cl">
<h2 class="datum-title-box">已加入群组</h2><?php if(is_array($usergrouplist)) foreach($usergrouplist as $key => $value) { ?><a href="forum.php?mod=group&amp;fid=<?php echo $value['fid'];?>" target="_blank"><?php echo $value['name'];?></a> &nbsp;
<?php } ?>
</div>
<?php } ?>
<div class="centerbox1 cl">
...
<div id="psts" class="centerbox1 cl">
...
<?php if($clist) { ?>
<div class="centerbox1 cl">
<h2 class="datum-title-box">违规记录</h2>
...
</div><?php include template('home/space_footer_cont_2'); ?>