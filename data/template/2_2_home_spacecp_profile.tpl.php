...
0
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/home/spacecp_header.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/home/spacecp_footer.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/common/seccheck.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/home/spacecp_profile_nav.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/common/seditor.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/home/spacecp_footer.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/home/spacecp_header_name.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
|| checktplrefresh('./template/default/home/spacecp_profile.htm', './template/default/home/spacecp_header_name.htm', 1677493995, '2', './data/template/2_2_home_spacecp_profile.tpl.php', './template/elec_20220314_miaoly', 'home/spacecp_profile')
...
<?php if(!$_G['member']['freeze']) { if(!$_G['setting']['connect']['allow'] || !$conisregister) { ?>您必须填写原密码才能修改下面的资料<?php } elseif($wechatuser) { ?>您目前使用的是微信账号绑定本站，您可以在这里设置独立密码，只有设置了独立密码后本站需要填写密码的相应功能才可使用<?php } else { ?>您目前使用的是QQ账号绑定本站，您可以在这里设置独立密码，只有设置了独立密码后本站需要填写密码的相应功能才可使用<?php } } elseif($_G['member']['freeze'] == 1) { ?>
