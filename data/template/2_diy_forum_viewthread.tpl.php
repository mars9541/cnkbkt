...
0
|| checktplrefresh('./template/elec_20220314_miaoly/forum/viewthread.htm', './template/elec_20220314_miaoly/forum/viewthread_node.htm', 1677493898, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/elec_20220314_miaoly', 'forum/viewthread')
|| checktplrefresh('./template/elec_20220314_miaoly/forum/viewthread.htm', './template/elec_20220314_miaoly/forum/viewthread_fastpost.htm', 1677493898, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/elec_20220314_miaoly', 'forum/viewthread')
|| checktplrefresh('./template/elec_20220314_miaoly/forum/viewthread.htm', './template/elec_20220314_miaoly/forum/viewthread_node_body.htm', 1677493898, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/elec_20220314_miaoly', 'forum/viewthread')
|| checktplrefresh('./template/elec_20220314_miaoly/forum/viewthread.htm', './template/default/common/seditor.htm', 1677493898, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/elec_20220314_miaoly', 'forum/viewthread')
|| checktplrefresh('./template/elec_20220314_miaoly/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1677493898, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/elec_20220314_miaoly', 'forum/viewthread')
|| checktplrefresh('./template/elec_20220314_miaoly/forum/viewthread.htm', './template/default/common/upload.htm', 1677493898, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/elec_20220314_miaoly', 'forum/viewthread')
|| checktplrefresh('./template/elec_20220314_miaoly/forum/viewthread.htm', './template/default/common/seccheck.htm', 1677493898, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/elec_20220314_miaoly', 'forum/viewthread')
;?><?php include template('common/header'); $ucthread = C::t('forum_thread')->fetch_all_by_authorid($_G['forum_thread']['authorid'], 0,8);?><?php $ucauthor = DB::fetch_first("SELECT `follower`,`threads`,`following` FROM ".DB::table('common_member_count')." WHERE uid = ".$_G['forum_thread']['authorid']);?><link rel="stylesheet" type="text/css" id="time_diy" href="template/elec_20220314_miaoly/style/css/index.css" />
...
<?php if(!$post['first']) { ?>.t_f, .t_f td { font-size: 14px}<?php } if($close_leftinfo) { ?>
...
.t_f, .t_f td { text-align: center}
.pcb img { display: inline-block}
.ptg.mbm.mtn.cl { display: none}
<?php } ?>
...
<div class="focusbox"><div class="wp"><h1 class="focusbox-title"><?php echo $_G['forum_thread']['subject'];?></h1></div></div>
<div class="section">
<!--[diy=diynavtop]-->
...
<div id="pt" class="bm cl" style="margin-top: 13px; margin-bottom: 0;">
  <div class="z"> <a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><em>&raquo;</em><a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> <em class="display_none">&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>" class="display_none"><?php echo $_G['forum_thread']['short_subject'];?></a> </div>
</div>
</div>

<?php if(!empty($_G['setting']['pluginhooks']['viewthread_top'])) echo $_G['setting']['pluginhooks']['viewthread_top'];?> <?php echo adshow("text/wp a_t");?><style id="diy_style" type="text/css">
</style>
...
<div id="ct" class="wp cl <?php if($close_leftinfo) { ?> ct2<?php } ?>"> <div class="mn" style="width: 838px; <?php if($close_leftinfo) { ?>padding: 20px; border-radius: 4px; border: 1px solid #EEEEEE;<?php } if(!$close_leftinfo) { ?>width: 100%;<?php } ?>">
<?php if(!$close_leftinfo) { ?>
  <div class="elecfbhf"> <a class="elec_pst_btn" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖">发布主题</a> 
  ...
  <div id="pgt" class="pgs mbm cl <?php if($modmenu['thread']) { ?>pbm bbs<?php } ?>" style=" display:none;">
    ...
    <button id="newspecial" class="pn pnc" onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&extra=<?php echo $extra;?>&sortid=<?php echo $id;?>'"><strong>我要<?php echo $name;?></strong></button>
  ...
  <div id="postlist" class="pl bm <?php if(!$close_leftinfo) { ?>elecconone<?php } else { ?>elec_all_replies<?php } ?>"> 
    ...
    <div id="pl_top" class="box mb20">
      <table cellspacing="0" cellpadding="0">
        <tr class="ad">
          <td class="pls"></td>
            <td class="plc" 
          <?php if($close_leftinfo) { ?> style="padding: 0;"<?php } ?>>
            </td>
        </tr>
        ...
        <tr> 
          ...
          <td class="pls vm ptm"><?php } else { ?>
            
          <td class="pls ptm pbm xi1" colspan="2"><?php } ?> 
            
            <img src="<?php echo IMGDIR;?>/thread_prize_s.png" class="hm" alt="回帖奖励" /> <strong><?php echo $_G['forum_thread']['replycredit'];?> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?></strong> 
            
            <?php if(!$close_leftinfo) { ?></td>
          <td class="plc ptm pbm xi1"><?php } else { ?> 
            
            &nbsp;&nbsp;&nbsp;&nbsp; 
            
            <?php } ?> 
            
            回复本帖可获得 <?php echo $_G['forum_thread']['replycredit_rule']['extcredits'];?> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?>奖励! 每人限 <?php echo $_G['forum_thread']['replycredit_rule']['membertimes'];?> 次<?php if($_G['forum_thread']['replycredit_rule']['random'] > 0) { ?><span class="xg1">(中奖概率 <?php echo $_G['forum_thread']['replycredit_rule']['random'];?>%)</span><?php } ?></td>
        </tr>
        ...
        <tr> 
          ...
          <td class="pls vm ptm"><img src="<?php echo IMGDIR;?>/rushreply_s.png" class="vm" alt="抢楼" /> <strong>抢楼</strong></td>
          <td class="plc ptm pbm xi1"><?php } else { ?>
            
          <td class="plc ptm pbm xi1" colspan="2"><img src="<?php echo IMGDIR;?>/rushreply_s.png" class="vm" alt="抢楼" /> 
            ...
            <p class="ptn"> 
              ...
              <?php if($countrushpost) { ?>[<strong><?php echo $countrushpost;?></strong>]个楼层已中奖<?php } else { ?> 暂时还没有楼层中奖 <?php } ?>&nbsp;&nbsp; <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>" class="xi2">返回抢楼帖</a> </p>
    ...
    <div class="td_tit cl" style="text-align: center;"> 
      ...
      <div class="vwthduser cl"> 
        
        <?php if($_G['page'] > 1) { ?> 
        
        <?php if($_G['forum_thread']['authorid'] && $_G['forum_thread']['author']) { ?> 
        
        <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" title="<?php echo $_G['forum_thread']['author'];?>"><?php echo avatar($_G[forum_thread][authorid],middle);?></a> 楼主: <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" title="<?php echo $_G['forum_thread']['author'];?>"><?php echo $_G['forum_thread']['author'];?></a> 
      ...
      <h1 class="v_tit <?php if(!$close_leftinfo) { ?>z<?php } ?>"> <span id="thread_subject"><?php echo $_G['forum_thread']['subject'];?></span> </h1>
      
      <?php if(!$close_leftinfo) { ?> 
      
      <span class="vwthdreplies y"> <strong><?php echo $_G['forum_thread']['allreplies'];?></strong></br>
      回复 </span> <span class="vwthdviews y"> <strong><?php echo $_G['forum_thread']['views'];?></strong></br>
      查看 </span> 
      ...
      <span class="xg1 <?php if(!$close_leftinfo) { ?>z<?php } ?>" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>> 
      ...
      <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php echo $fromuid;?>" onclick="return copyThreadUrl(this, '<?php echo $_G['setting']['bbname'];?>')" <?php if($fromuid) { ?>title="您的朋友访问此链接后，您将获得相应的积分奖励"<?php } ?>>[复制链接]</a> </span> 
...
jQuery(this).children(".vwthdewmsub").hide();
    ...
    <table cellspacing="0" cellpadding="0" class="ad" style=" display:none;">
      <tr>
        <td class="pls"><?php if(!$close_leftinfo) { ?></td>
          <td class="plc" 
        <?php if($close_leftinfo) { ?> style="padding: 0;"<?php } ?>> 
    ...
    <?php if(is_array($postlist)) foreach($postlist as $post) { ?> 
    
    <?php if($rushreply && $_GET['checkrush'] && $post['rewardfloor'] != 1) { ?> 
...
<div class="pi <?php if($close_leftinfo && $post['first']) { ?>tpi<?php } ?>"<?php if(!$post['first']) { ?>style="padding-bottom: 15px; border-bottom: 1px dashed #EEEEEE;"<?php } ?>>
...
<div class="authi <?php if($post['first'] ) { ?>firstauthi<?php } ?>" style="font-size: 14px;<?php if($post['first'] && $close_leftinfo) { ?> text-align: center;<?php } ?>">
...
<?php } if($close_leftinfo) { ?><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2" <?php if(!$post['first']) { ?>style="font-size: 12px;"<?php } ?>><?php if($post['first']) { ?><em class="display_none">作者：</em><?php } ?><?php echo $post['author'];?></a><?php echo $authorverifys;?><?php } if($close_leftinfo) { } if($post['first'] && $close_leftinfo) { ?><span class="pipe" style="padding: 0 1px; color: #E6E6E6;">|</span><?php } ?>

<em id="authorposton<?php echo $post['pid'];?>" <?php if(!$post['first']) { ?>style="padding: 0 0 0 5px; font-size: 12px;"<?php } ?>><?php if($post['first']) { ?><em class="display_none">时间：</em><?php } if(!$post['first']) { ?>发表于：<?php } ?><?php echo $post['dateline'];?></em>
<?php if($post['first']) { ?><span class="pipe" style="padding: 0 1px; color: #E6E6E6;">|</span><?php } ?>
                    <?php if($post['first']) { ?>阅读：<?php echo $_G['forum_thread']['views'];?><?php } if($post['first']) { if($post['invisible'] == 0) { if($post['first']) { ?><span class="display_none pipe" style="padding: 0 0 0 4px; color: #E6E6E6;">|</span><?php } if(!IS_ROBOT && !$_GET['authorid'] && !$_G['forum_thread']['archiveid']) { ?>


<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>&amp;authorid=<?php echo $post['authorid'];?>" rel="nofollow" class="display_none">只看该作者</a>


<?php } elseif(!$_G['forum_thread']['archiveid']) { ?>


<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>" rel="nofollow" class="display_none">显示全部楼层</a>
...
<?php if($close_leftinfo) { ?>
<div style="background:#f8f8f8;padding: 50px 10px;border:1px dashed #ccc;position: relative;z-index:1;text-align:center;margin:15px 0; font-size: 16px;" class="download_1">完整套图：
<span style="color: red">联系站长<a href="vip.php?action=paycenter" class="xh-btn xh-btn-warning xh-btn-sm" style="">开通VIP</a>可下载全站内容。<span style="position: absolute;top:15px;left:15px;font-size:90%;color:#90949c;">
  付费下载
</span>
<span style="position: absolute;top:10px;right:10px;"><img style="width:22px;" src="template/elec_20220314_miaoly/style/noshow.png" alt=""></span>
</span></div>
...
<?php if($post['tags']) { $tagi = 0;?><?php if(is_array($post['tags'])) foreach($post['tags'] as $var) { if($tagi) { } ?><a title="<?php echo $var['1'];?>" href="misc.php?mod=tag&amp;id=<?php echo $var['0'];?>" target="_blank" style="line-height: 26px; margin: 0; font-size: 14px; border: 0; color: #888888 !important; background: none;"><?php echo $var['1'];?></a><?php $tagi++;?><?php } } if($relatedkeywords) { ?><span><?php echo $relatedkeywords;?></span><?php } ?>
</div>
...
<?php } } if($post['first']) { ?>
  <?php if($modmenu['thread']) { ?>
    ...
    <div id="elecnew_guanli_menu" class="p_pop pop_manager cl"> 
...
<div class="rep_s cl">
    	...
    	<h2 class="z" style="font-size: 14px; font-weight: bold;">大神点评<em style="height: 18px; line-height: 18px; color: #FFFFFF; background: #FF6651; font-size: 12px; font-weight: 400;"><?php echo $_G['forum_thread']['allreplies'];?></em></h2>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_endline'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_endline'][$postcount];?>
  ...
  <?php $nxtpage = $page + 1;?>  
  <div class="pgbtn" style="display: none;"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true">下一页 &raquo;</a></div>
  
  <?php } ?>
  
  <div class="pgs mbm cl" style="margin-top: 20px;"> <?php echo $multipage;?> <span class="pgb y"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?> style="display: none;"><a href="<?php echo $upnavlink;?>">返回列表</a></span> 
  ...
  <?php if($close_leftinfo) { ?><!--[diy=diyfastposttop]-->
...
<?php if($_G['uid']) { ?>
    ...
    <p class="ptm pnpost" style="font-size: 12px;">


<a href="home.php?mod=spacecp&amp;ac=credit&amp;op=rule&amp;fid=<?php echo $_G['fid'];?>" class="y" target="_blank" style="font-size: 12px;">本版积分规则</a>


<button <?php if($allowpostreply) { ?>type="submit" <?php } elseif(!$_G['uid']) { ?>type="button" onclick="showWindow('login', 'member.php?mod=logging&action=login&guestmessage=yes')" <?php } if(!$seccodecheck) { ?>onmouseover="checkpostrule('seccheck_fastpost', 'ac=reply');this.onmouseover=null" <?php } ?>name="replysubmit" id="fastpostsubmit" class="pn pnc vm" value="replysubmit" tabindex="5" style="padding: 0 10px; height: 25px; line-height: 25px; border-radius: 4px; background: #FF6651 !important;">发表回复</button>
...
<?php } ?>
  ...
  <?php if($close_leftinfo) { ?><!--[diy=diyfastposttop1]-->
  <div id="diyfastposttop1" class="area"></div>
  <!--[/diy]--><?php } ?>
  ...
  <?php if(is_array($_G['medal_list'])) foreach($_G['medal_list'] as $medalid => $medal) { ?>  
  <div id="md_<?php echo $medalid;?>_menu" class="tip tip_4" style="display: none;">
...
<div class="sd">
  <div class="page-news-author cl" style="padding: 20px; margin: 0 0 20px 0; border: 0; border-radius: 4px; background: #F6F6F6; text-align: left;">
    <div class="cl">
    <div class="page-news-authorimg" style="float: left; width: 60px; height: 60px;"><?php echo avatar($_G[forum_thread][authorid],large);?></div>
    <div class="y cl" style="width: 180px; position: relative;">
    <h2 class="page-news-authorname" style="line-height: 20px; padding: 0; margin: 0 0 15px 0; font-size: 16px; font-weight: bold;"><a class="eleclzname" href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" title="访问我的空间" c="<?php echo $_G['forum_thread']['authorid'];?>"><?php echo $_G['forum_thread']['author'];?></a>      
      <?php if(is_array($postlist)) foreach($postlist as $post) { ?> 
      
      <?php if($post['first']) { ?> 
      
      <?php if(is_array($post['verifyicon'])) foreach($post['verifyicon'] as $vid) { ?> 
      
      <a href="home.php?mod=spacecp&amp;ac=profile&amp;op=verify&amp;vid=<?php echo $vid;?>" target="_blank"><?php if($_G['setting']['verify'][$vid]['icon']) { ?><img src="<?php echo $_G['setting']['verify'][$vid]['icon'];?>" class="vm" alt="<?php echo $_G['setting']['verify'][$vid]['title'];?>" title="<?php echo $_G['setting']['verify'][$vid]['title'];?>" /><?php } else { ?><?php echo $_G['setting']['verify'][$vid]['title'];?><?php } ?></a> 
      
      <?php } ?> 
      
      <?php if(is_array($post['unverifyicon'])) foreach($post['unverifyicon'] as $vid) { ?> 
      
      <a href="home.php?mod=spacecp&amp;ac=profile&amp;op=verify&amp;vid=<?php echo $vid;?>" target="_blank"><img src="<?php echo $_G['setting']['verify'][$vid]['unverifyicon'];?>" class="vm" alt="<?php echo $_G['setting']['verify'][$vid]['title'];?>" title="<?php echo $_G['setting']['verify'][$vid]['title'];?>" /></a> 
    ...
    <div class="page-news-author-btns notfollow" style="position: absolute; right: 0; top: 0; width: auto; margin: 0;">
      <div class="btn0" style="display: inline-block; width: auto; height: 14px; line-height: 14px; margin: 0; padding: 3px 8px; background: #FF6651; border-radius: 4px; font-size: 14px;"><a href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $post['authorid'];?>" id="followmod_<?php echo $post['authorid'];?>" title="收听TA" style="color: #FFFFFF; text-decoration: none !important;">关注Ta</a></div>
    </div>
    <div class="a_infos cl" style="color: #555555;">
      <div class="page-news-authorviewinfoitem" style="width: auto;">
        <div class="cl">主题 <?php echo DB::result_first('SELECT posts FROM '.DB::table('common_member_count').' WHERE uid ='.$_G['forum_thread']['authorid'].''); ?></div>
      </div>
      <span class="z" style="padding: 0 8px; height: 14px; display: block;"></span>
      <div class="page-news-authorviewinfoitem" style="width: auto;">
        <div class="cl">帖子 <?php echo $ucauthor['threads'];?></div>
      </div>
      <span class="z" style="padding: 0 8px; height: 14px; display: block;"></span>
      <div class="page-news-authorviewinfoitem" style="width: auto;">
        <div class="cl">积分 <?php echo DB::result_first('SELECT credits FROM '.DB::table('common_member').' WHERE uid ='.$_G['forum_thread']['authorid'].''); ?></div>
      </div>
    </div>
    </div>
    </div>
    <div class="authorSignDiv" style="padding-top: 15px; padding-bottom: 15px; border-bottom: 1px solid #EEEEEE;"><span style="font-size: 12px; color: #555555;"><?php $xlmmbio = DB::fetch_all("SELECT bio FROM  ".DB::table('common_member_profile')." WHERE `uid` = $thread[authorid]");?> 
      <?php if(is_array($xlmmbio)) foreach($xlmmbio as $key => $xlmmbio) { ?> <?php if($xlmmbio['bio']) { ?><?php echo $xlmmbio['bio'];?><?php } else { ?>此人很懒，什么也没留下。<?php } ?> <?php } ?></span></div>
    <div class="page-news-author-recentArticles" style="margin-top: 10px;">
       				<ul style="border-top: 0;">
        <?php $time_hotlist = array();?>        <?php $time_hotlist = DB::fetch_all("SELECT tid,views,subject FROM ".DB::table('forum_thread')." where authorid=".$_G[forum_thread][authorid]." and tid !=".$_G[tid]." ORDER BY views DESC limit 8");?><?php if(is_array($time_hotlist)) foreach($time_hotlist as $hotlist) { ?><li style="height: 30px; line-height: 30px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $hotlist['tid'];?>" target="_blank" style="font-size: 14px; color: #555555;"><?php if($_G['cache']['forums'][$thread['fid']]['name']) { ?><em style="color: #FF6651; margin: 0 8px 0 0;">&#8226;</em><?php } ?><?php echo $hotlist['subject'];?></a><p></p></li>
<?php } ?>
</ul>
    </div>
    <a href="home.php?mod=follow&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>&amp;do=view&amp;from=space" style="display: block; width: 100%; height: 36px; line-height: 36px; margin: 10px 0 0 0; color: #FFFFFF; font-size: 14px; text-align: center; background: #CCCCCC;" class="read_author">阅读作者更多精彩帖子</a>
  </div>

  <!--[diy=diy01]-->
  <div id="diy01" class="area"></div>
  <!--[/diy]-->
  ...
  <!--[diy=elec_tuijian]-->
  <div id="elec_tuijian" class="area"></div>
  <!--[/diy]--> 
...
</div><?php include TPLDIR.'/portal/get_forum_data.php';?><?php $photo = fetch_photo($fids, $_G['page'], $pagenum, $order)?><div class="thread_rec cl" style="display: none;">
<div class="wp cl">
<div class="cl">
<?php if($photo['threadlist']) { ?>
            <ul class="miao_list">
            <?php if(is_array($photo['threadlist'])) foreach($photo['threadlist'] as $thread) { ?>    <?php $thread['coverpath'] = get_thread_cover($thread['tid'], $thread['cover']);?>                <li>
            <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>" title="<?php echo $thread['subject'];?>" target="_blank" class="img_box">
<img src="<?php echo(getforumimg($thread[aid],0,224,330))?>" title="<?php echo $thread['subject'];?>" style="width: auto; height: 330px;">
            </a>
            <div class="info_box cl">
            <h3>
                <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>" target="_blank"><?php echo $thread['subject'];?></a>
            </h3>
            <div class="time cl"><?php echo date("Y-m-d", $thread['dateline']); ?></div>
            </div>
        </li>
        <?php } ?>
                        </ul>
...
</div><?php $multipage = multi($photo['count'], $pagenum, $_G['page'], $url);?><?php if($multipage) { ?>
<div class="pagex cl" style="padding: 20px 0 40px 0;">
<?php echo $multipage;?>
</div>
<?php } ?>
</div>
...
<div style="display: none;"><?php if(!empty($_G['setting']['pluginhooks']['viewthread_modoption'])) echo $_G['setting']['pluginhooks']['viewthread_modoption'];?></div>
